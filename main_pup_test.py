...
#BOL006b-43-1
#stack=mn.fit_single_model('bbl031f-a1', 291, 'fb18ch50_wc03_fir10_fit00', autoplot=True)
...
#stack=mn.fit_single_model('eno052d-a1', 294, 'perfectpupil50_pupgain_fit00_nested10', autoplot=True,stimidx=55)
#alldata=stack.data
#alldata=stack.data
