...
def fit00(stack):
    ...
    """
    module = nm.metrics.mean_square_error()
    stack.append(module)
...
def fit03(stack):
    ...
    Should be appended last in a modelname (excepting "nested" keywords)
    """
    module = nm.metrics.mean_square_error(shrink=0.1)
    stack.append(module)
    stack.error = module.error
    stack.evaluate(2)
...
def fit04(stack):
    ...
    Should be appended last in a modelname (excepting "nested" keywords)
    """
    module = nm.metrics.likelihood_poisson()
    stack.append(module)
    stack.error = module.error
    stack.evaluate(2)
...
def fit00h1(stack):
    ...
    Should be appended last in a modelname (excepting "nested" keywords)
    """
    module = nm.metrics.pseudo_huber_error(b=1.0)
    stack.append(module)
    stack.error = module.error
    stack.evaluate(2)
...
def fititer00(stack):
    ...
    Should be appended last in a modelname (excepting "nested" keywords)
    """
    module = nm.metrics.mean_square_error(shrink=0.5)
    stack.append(module)
    stack.error = module.error
